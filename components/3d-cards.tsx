...
export function ThreeDCardDemo() {
  return (
    <div className="container grid px-1 md:grid-cols-2 md:px-6">
      <h1 className="text-4xl text-center text-purple-600">Contributor</h1>
      ...
      <CardContainer>
        <CardBody className="relative group/card hover:shadow-2xl hover:shadow-emerald-500/[0.1] bg-zinc-800 backdrop-blur bg-opacity-20 border-black/[0.3] w-auto sm:w-[30rem] h-auto rounded-lg p-6 ">
          ...
          >
            Explore new Tech stuffs .Feel Free to head on to the issue section
            and toss any comments.
          </CardItem>
          <CardItem translateZ="100" rotateX={-5} className="w-full mt-6">
            <Image
              src="/images/ak88.webp"
              height="700"
              width="700"
          ...
          <div className="flex justify-between items-center mt-20">
            ...
            >
              <Button variant="ghost" asChild>
                <a
                  href="https://aksshay88.github.io/Portfolio-Profile-using-HTML-and-CSS/#"
                  target="_blank"
            ...
            >
              <a
                title="Github"
                href="https://github.com/Aksshay88"
                target="_blank"
                rel="noopener noreferrer"
