...
export const MacbookScroll = ({
  ...
  return (
    ...
    >
      ...
      />
      {/* Base area */}
      <div className="h-[22rem] w-[32rem] bg-gray-700 dark:bg-[#272729] rounded-2xl overflow-hidden relative -z-10">
        {/* above keyboard bar */}
...
export const KBtn = ({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "h-6 w-6 bg-black rounded-[3.5px] flex items-center justify-center",
          className
        )}
        style={{
          boxShadow:
