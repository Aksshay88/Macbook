    ...
    <div className="max-w-3xl mx-auto px-4 pt-28 leading-7">
      ...
      <div className="mb-8">
        <p className="dark:text-neutral-300 text-neutral-700">
          ...
          everyday tasks and unleash your potential. At Apple, we are committed
          to your privacy and security. This document outlines how we handle
          your data when you use your Mac. We are dedicated to protecting your
          information and providing you with control over your privacy settings.
          At Mac, we are committed to protecting your privacy and ensuring the
      ...
      <div className="mb-8">
        ...
        <ol className="list-decimal ml-6 dark:text-neutral-300 text-neutral-700">
          ...
          <li className="my-2">
            ...
            information. This data is anonymized and does not identify you
